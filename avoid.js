function pointIntersectElement (point, element) {
...
if (element === 'index'){
     ...
     cWidth = 150; // these set size of cener area to be avoided
     cHeight = 200;
}
else if (element === 'me'){
     cWidth = 370;
    ...
    */
    ...
    var titleP2 = [ maxWidth/2 + cWidth-(cWidth/3) , maxHeight/2 - cHeight]
    var titleP3 = [ maxWidth/2 + cWidth-(cWidth/3) , maxHeight/2 + cHeight] // angolo destro basso titolo
